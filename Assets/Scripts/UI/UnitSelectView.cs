...
{
    [RequireComponent(typeof(UnitSelectSystem))]
    public class UnitSelectView : MonoBehaviour
    {
        ...
        public UnitSelectSystem System { get; private set; }

        public void Initialize()
        {
            System = GetComponent<UnitSelectSystem>() ?? throw new NullReferenceException();
            System.Initialize();
